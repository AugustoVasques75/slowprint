...
for i in range(3): slowprint("Hello World my friend.", delay=0.05, yoyo = True, vertical=True)
for i in range(3): slowprint("Hello World my friend.", delay=0.05, yoyo = True, vertical=False)